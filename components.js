                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12 text-center md:text-left">
                    ...
                    <div class="flex flex-col items-center md:items-start">
                        ...
                        <ul class="space-y-3 text-sm text-[#475569]">
                            <li><a href="index.html" class="hover:text-[#2563eb] transition-colors">Home</a></li>
                            <li><a href="about.html" class="hover:text-[#2563eb] transition-colors">About</a></li>
                            <li><a href="contact.html" class="hover:text-[#2563eb] transition-colors">Contact Us</a></li>
                            <li><a href="privacy.html" class="hover:text-[#2563eb] transition-colors">Privacy Policy</a></li>
                            <li><a href="work.html" class="hover:text-[#2563eb] transition-colors">Additional Work</a></li>
                        </ul>
                    </div>
